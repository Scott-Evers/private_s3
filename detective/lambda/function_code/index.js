...
function evaluateChangeNotificationCompliance(configurationItem, ruleParameters) {
    console.log(JSON.stringify(configurationItem))
    checkDefined(configurationItem, 'configurationItem');
    checkDefined(configurationItem.configuration, 'configurationItem.configuration');
    checkDefined(ruleParameters, 'ruleParameters');

    if (configurationItem.resourceType !== 'AWS::S3::Bucket') {
        console.log('NOT_APPLICABLE: ', configurationItem.resourceType)
        return 'NOT_APPLICABLE';
    } else if (configurationItem.supplementaryConfiguration.PublicAccessBlockConfiguration.blockPublicAcls &&
                configurationItem.supplementaryConfiguration.PublicAccessBlockConfiguration.ignorePublicAcls &&
                configurationItem.supplementaryConfiguration.PublicAccessBlockConfiguration.blockPublicPolicy &&
                configurationItem.supplementaryConfiguration.PublicAccessBlockConfiguration.restrictPublicBuckets) {
        return 'COMPLIANT';
    }
